...
public class MainActivity extends BaseActivity
    ...
    private FloatingActionButton fab, fabRemove, fabAdd;
    ...
    private void prepareFABs() {
        ...
        fabRemove = (FloatingActionButton) findViewById(R.id.fab1);
...
//                mGeofencesAdded = false;
    ...
    public void onPermissionResult(Permiso.ResultSet resultSet) {
        super.onPermissionResult(resultSet);
        if (resultSet.isPermissionGranted(Manifest.permission.ACCESS_FINE_LOCATION) && resultSet.isPermissionGranted(Manifest.permission.ACCESS_COARSE_LOCATION)) {
